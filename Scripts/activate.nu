...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'C:\Users\Алексей\Desktop\GreekBrains\ДОМАШКА\Backend-Flask-FastAPI\Seminar3_DB'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'C:\Users\Алексей\Desktop\GreekBrains\ДОМАШКА\Backend-Flask-FastAPI\Seminar3_DB\Scripts\deactivate.nu'
